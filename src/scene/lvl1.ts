...
export default class Lvl1 extends Phaser.Scene {
  ...
  create() {
    ...
    this.distractionTiles.l1c1 = new Distraction(
      this,
      150,
      196,
      'l1c1',
    ...
    this.distractionTiles.l1c2 = new Distraction(
      this,
      400,
      196,
      'l1c2',
    ...
    this.distractionTiles.l1c3 = new Distraction(
      this,
      650,
      196,
      'l1c3',
    ...
    this.distractionTiles.l2c1 = new Distraction(
      this,
      150,
      410,
      'l2c1',
    ...
    this.distractionTiles.l2c2 = new Distraction(
      this,
      400,
      410,
      'l2c2',
    ...
    this.distractionTiles.l2c3 = new Distraction(
      this,
      650,
      410,
      'l2c3',
    ...
    this.events.on('distractionClick', (event: DistractionClickEvent) =>
      this.distractionButtonOnClickHandler(event)
    );
